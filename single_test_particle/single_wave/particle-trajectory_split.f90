program main
    ...
    integer, parameter :: thread_number = 10
    integer, parameter :: particle_in_thread = 17
    CHARACTER(128), dimension(thread_number) :: file_input
    character(128), dimension(thread_number, particle_in_thread) :: file_output
    ...
    do thread_i = 0, thread_number-1
        ...
        file_input(thread_i + 1) = &
            & '/home/satanka/Documents/fort/TPS-DAW/TPS-KAW/results_particle/myrank000/particle_trajectory' // &
