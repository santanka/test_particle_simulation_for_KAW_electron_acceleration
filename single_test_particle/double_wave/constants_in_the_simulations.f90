module constants_in_the_simulations
    ...
    !-------------------------------------
    INTEGER, PARAMETER          :: n_time = 500000  ! !80000 (10.9932 [s])
    ...
    double precision, parameter :: switch_wave_growth_para = 1d0
    double precision, parameter :: switch_wave_growth_perp = 0d0

    double precision, parameter :: wave_initial_to_threshold = 1d6
    double precision, parameter :: wave_parallel_threshold_point = 5d0 * deg2rad ![deg]->[rad]
