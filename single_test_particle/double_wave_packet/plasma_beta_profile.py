...
channel = 3
# 1:plasma beta ion, 2:δBpara/δEpara, 3:F_δBpara/F_δEpara
...
# mlat
mlat_deg = np.linspace(-60, 60, 10000)
mlat_rad = mlat_deg * deg2rad

dir_name = f'/mnt/j/KAW_simulation_data/single_test_particle/double_wave_packet/'
...
if channel == 3:
    electron_energy = np.linspace(100, 1000, 10000) #[eV]
