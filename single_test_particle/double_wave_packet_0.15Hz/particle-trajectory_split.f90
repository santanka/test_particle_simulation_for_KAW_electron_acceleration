program main
    ...
    CHARACTER(126), dimension(thread_number) :: file_input
    character(130), dimension(thread_number, particle_in_thread) :: file_output
    ...
    do thread_i = 0, thread_number-1
        ...
        &'/mnt/j/KAW_simulation_data/single_test_particle/double_wave_packet/0.15Hz/results_particle/myrank000/particle_trajectory'&
