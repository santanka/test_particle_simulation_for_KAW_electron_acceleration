...
def main(args):
    ...
    ax_3_2 = fig.add_subplot(gs[1, 2], xlabel=r'$\psi$ [$\pi$ rad]', ylabel=r'$1 / \omega_{\mathrm{t}} \, \mathrm{d} f / \mathrm{d} t$', xlim=[-1, 1], ylim=[-5, 5])
    ax_3_3 = fig.add_subplot(gs[2, 2], xlabel=r'$\psi$ [$\pi$ rad]', ylabel=r'$g(S, \psi, \theta, \lambda)$', xlim=[-1, 1], ylim=[-7, 3])
