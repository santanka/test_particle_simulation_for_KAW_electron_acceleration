...
# Load data
def load_data_path(initial_Kperp_eq_min_eV, initial_Kperp_eq_max_eV, initial_S_value_min, initial_S_value_max, separate_number_mesh, separate_number_psi, grid_scale, psi_exit, initial_Kperp_eq_main, initial_S_value_main):
...
def figure_plot(data_name, data):
    ...
    # plot setting
    fig_name = data_name.replace('.nc', '_test.png')
...
def main(initial_Kperp_eq_min_eV, initial_Kperp_eq_max_eV, initial_S_value_min, initial_S_value_max, separate_number_mesh, separate_number_psi, grid_scale, psi_exit, initial_Kperp_eq_main, initial_S_value_main):
    data_name = load_data_path(initial_Kperp_eq_min_eV, initial_Kperp_eq_max_eV, initial_S_value_min, initial_S_value_max, separate_number_mesh, separate_number_psi, grid_scale, psi_exit, initial_Kperp_eq_main, initial_S_value_main)
    print(data_name)
...
main(1E0, 1E3, 1E-1, 1E0, 20, 10, 'linear', -1E1 * np.pi, 1E0, 1E-1)