...
def main(args):
    ...
    dir_name = f'/mnt/j/KAW_simulation_data/single_test_particle/keisan/test_particle_simulation_phase_trapping_initialpsi_plus_0.5_pi'
    ...
    axes = [ax_1_1, ax_1_2, ax_2_1, ax_2_2]
