...
ax_1.plot(mlat_deg_array, delta_scale_array, color='k', lw=4, label=r'$L_{\mathrm{S}}$')
#ax_1.hlines(planet_radius, 0E0, mlat_upper_limit_deg, color='dimgrey', lw=4, label=r'$R_{\mathrm{E}}$', linestyles='dashed')
ax_1.legend()
ax_1.minorticks_on()
...
#ax_2.plot(mlat_deg_array, delta_2_array / delta_array, color='green', lw=4, label=r'$\delta_{2} / \delta_{1}$')
#ax_2.plot(mlat_deg_array, delta_array**2E0 / delta_2_array, color='blue', lw=4, label=r'$\delta_{1}^{2} / \delta_{2}$')
ax_2.plot(mlat_deg_array, Gamma_array-1, color='green', lw=4, label=r'$\Gamma - 1$')
ax_2.plot(mlat_deg_array, kpara_L_array, color='k', lw=4, label=r'$k_{\parallel}L_{\mathrm{S}}$')
